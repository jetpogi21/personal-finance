...
export const getMonthName = (monthId: number) => {
  // Create a dummy date object with the given month ID
  const date = new Date(2000, monthId - 1);

  // Use the toLocaleString() method with the 'en-US' locale to get the month name
