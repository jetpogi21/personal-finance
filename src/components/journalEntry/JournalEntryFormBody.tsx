...
import { TJournalEntryFormHook } from "../../hooks/journalEntry/useJournalEntryForm";
import { Stack, Box, Container, Paper } from "@mui/material";
import JournalEntryForm from "./JournalEntryForm";
import Breadcrumbs from "../breadcrumbs/Breadcrumbs";
import Dialog from "../dialog/Dialog";

const JournalEntryFormBody: React.FC<{
  props: TJournalEntryFormHook;
      ...
      <Container maxWidth="lg">
        <Stack direction="column" spacing={2}>
          <Paper>
            ...
            <JournalEntryForm
              journalEntry={mainListObject.journalEntry}
...
export default JournalEntryFormBody;
